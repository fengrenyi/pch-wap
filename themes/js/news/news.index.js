	    ...
	    var _list = $("#list").val();
	      if(_list == 0){
				for (var i=0; i<1; i++) {
					el.append(
			       ' <div class="div-list">'
			         +' <a href="" class="a-title textAlign textOver">' 
				         +'  大品牌掀“低价”风云 加速家具行业洗牌步调户思维催家具业裂变 家具行业转型喜忧参半'
			         +'</a>'
			          +'<div class="div-img">' 
				           +' <a href=""><img src="../../themes/images/news/test1.jpg" /></a>' 
				           +' <a href=""><img src="../../themes/images/news/test1.jpg" /></a>' 
				           +' <a href=""><img src="../../themes/images/news/test1.jpg" /></a>' 
			           +'</div>'
			      ...
			      + ' <div class="div-list">'
			         ...
			         +'</a>'
			          ...
			          +'</div>'
					        +'<div class="div-ad">'
				             +'<a href="" class="textOver">大品牌掀“低价”风云 加速家具行业洗</a> '
				             +'<a href="" ><img src="../../themes/images/news/test3.jpg" /></a>'
				           +'</div> '
			        + '</div>'
					);
				}    	      	
